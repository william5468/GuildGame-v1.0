...
"tavern_treat_title": "全員にビールを振る舞う",
        ...
        "tavern_beer_success": "乾杯！{count}人の冒険者に酒を振る舞いました。ギルドマスターへの親密度が +{gmInc}、仲間同士の絆が +{bondInc} 上昇しました！",
        "no_adventurers_available": "現在ギルドに正規メンバーがいません！",
    guild_slots_title: "冒険者宿舎",
guild_effect_slots: "冒険者の最大雇用枠",
    reception_effect_quests: "クエスト掲示板の最大枠",
reception_effect_rolls: "1日のクエスト発生回数",
    reception_level_current: "現在の受付スペース Lv",
reception_level_next: "次レベル: {next} (費用: {cost}G)",
reception_desc: "ギルドのロビーを拡張し、クエストの掲示枠と1日のクエスト発生回数を増やします。",
reception_expansion_button: "受付スペースを拡張する",
reception_max_expanded: "受付スペースは最大まで拡張されています。",
reception_expanded: "受付スペースが Lv {level} に拡張されました！より多くの依頼を受けられるようになります。",
max_expansion_reached: "これ以上拡張することはできません。",
    "blacksmith_enhance_failure": "強化失敗… {item} +{level} のレベルはそのままですが、クリスタルを失いました。",
...
'leave_rejected': '{name}の{days}日間休暇を拒否しました（好感度 -{penalty}）',
    ...
    "quest_trade_failure_desc3": "事前に支払った購入コストは失われました。",
    "quest_trade_success_title": "貿易クエスト成功！",
    "quest_success_title": "クエスト成功！",
    "quest_failure_title": "クエスト失敗！",
    "no_one_returned": "誰も帰還しませんでした…",
    "days_taken": "所要日数: {days} 日",
    "multiple_days": "複数",
    "trade_purchased_materials": "購入素材: {materials}",
    "trade_gold_reward": "+{reward} Gold（売却収益）",
    "reputation_gain": "Reputation +{repGain}",
    "reputation_loss": "Reputation -{repLoss}",
    "gold_reward": "+{gold} Gold",
    "adventurer_payout": " (冒険者分配: {payout}G)",
    "adventurer_payout_note": "[{payout} Goldは冒険者に分けた]",
    "exp_short": "Exp",

    // === 貿易クエスト盗賊遭遇 ===
    "trade_no_guard_bandit": "護衛なしのため大規模な盗賊襲撃！\nほとんどの荷物と収益を失った…（損失率80%）",
    "trade_bandit_attack": "盗賊の襲撃に遭った！",
    "trade_bandit_lost_gold": "失われた売却収益: {lostGold}G",
    "trade_bandit_lost_items": "失われた購入品: {items}",
    "trade_bandit_loss_rate": " 損失率{rate}%",

    // === 通常クエスト成功ボーナス ===
    "defense_orb_bonus": "Reputation Bonus: {qty} × EXPオーブ (小) を獲得!",
    "dungeon_treasure_gold": "ダンジョン{floor}階の宝: +{gold}G",
    "enhancement_crystal": "強化クリスタル",
    "item_found": "{name}発見！",
    "item_found_qty": "{name} x{qty}発見！",
    "rare_indicator": " (レア！)",
    "cursed_mana_fragment": "呪われた魔力の石片",
    "cursed_goblin_guard": "呪われたゴブリンの守り",
    "carnivorous_flower_tooth": "食肉花の歯",
    "collection_item": "(コレクションアイテム)",
    "grateful_client_rep": "感謝のクライアントが言葉を広め、+{extraRep} Reputation！",
    "npc_discovered": "{npc}を発見！ NPCでサイドクエストを確認。",
    "exp_orb_small": "EXPオーブ (小)",
    "exp_orb": "EXPオーブ",
    "side_quest_exp_orb": "EXPオーブを受け取りました！（使用で冒険者のレベル+10）",
...
"expansion_purchased": "ギルドを拡張しました！",
...
"facility_upgraded": "{facility} has been upgraded to Level {level}!",
        ...
        "tavern_beer_success": "Cheers! You treated {count} adventurers. Friendliness to you +{gmInc}, and bonds between members +{bondInc}!",
        "no_adventurers_available": "No permanent members are at the guild right now!",
    guild_slots_title: "Adventurer Dormitory",
guild_effect_slots: "Max Adventurer Capacity",
    reception_effect_quests: "Max Quests on Board",
reception_effect_rolls: "Daily Quest Rolls",
    reception_level_current: "Current Reception Level",
reception_level_next: "Next Level: {next} (Cost: {cost}G)",
reception_desc: "Expands the guild lobby to allow more quest postings and additional daily recruitment rolls.",
reception_expansion_button: "Expand Reception Space",
reception_max_expanded: "Reception Space is fully expanded! (Max Capacity)",
reception_expanded: "Reception expanded to Level {level}! Your guild can now handle more quests.",
max_expansion_reached: "Maximum expansion level already reached.",
    "blacksmith_enhance_failure": "Enhancement failed! The {item} +{level} remains the same, but the crystal was lost.",
...
'leave_rejected': '{name}’s {days} day leave REJECTED (-{penalty} Friendliness)',
    ...
    "quest_trade_failure_desc2": "The plan failed due to insufficient or delayed adventurer assignments.",
    "quest_trade_failure_desc3": "Pre-paid purchase costs were lost.",
    "quest_trade_success_title": "Trade Quest Success!",
    "quest_success_title": "Quest Success!",
    "quest_failure_title": "Quest Failure!",
    "no_one_returned": "No one returned...",
    "days_taken": "Days taken: {days} days",
    "multiple_days": "multiple",
    "trade_purchased_materials": "Purchased materials: {materials}",
    "trade_gold_reward": "+{reward} Gold (sales revenue)",
    "reputation_gain": "Reputation +{repGain}",
    "reputation_loss": "Reputation -{repLoss}",
    "gold_reward": "+{gold} Gold",
    "adventurer_payout": " (adventurer payout: {payout}G)",
    "adventurer_payout_note": "[{payout} Gold distributed to adventurers]",
    "exp_short": "Exp",

    // === Trade Quest Bandit Encounter ===
    "trade_no_guard_bandit": "Large-scale bandit attack due to no escort!\nLost most cargo and profits... (80% loss)",
    "trade_bandit_attack": "Encountered bandits!",
    "trade_bandit_lost_gold": "Lost sales revenue: {lostGold}G",
    "trade_bandit_lost_items": "Lost purchased items: {items}",
    "trade_bandit_loss_rate": " Loss rate {rate}%",

    // === Normal Quest Success Bonuses ===
    "defense_orb_bonus": "Reputation Bonus: {qty} × Small EXP Orb(s) obtained!",
    ...
    "rare_indicator": " (Rare!)",
    "cursed_mana_fragment": "Cursed Mana Fragment",
    "cursed_goblin_guard": "Cursed Goblin Guard",
    "carnivorous_flower_tooth": "Carnivorous Flower Tooth",
    "collection_item": "(Collection Item)",
    "grateful_client_rep": "Grateful client spread the word, +{extraRep} Reputation!",
    "npc_discovered": "Discovered {npc}! Check side quests at NPCs.",
    "exp_orb_small": "Small EXP Orb",
    "exp_orb": "EXP Orb",
    "side_quest_exp_orb": "Received EXP Orb! (Use to increase adventurer level +10)",
    "fetch_item_reward": "+{qty} {name}",
...
"expansion_purchased": "Guild expanded!",
...
"facility_upgraded": "{facility} 已升級至等級 {level}！",
        ...
        "tavern_beer_success": "乾杯！您請了 {count} 位冒險者喝了一輪。對您的親密度 +{gmInc}，夥伴間的友好度 +{bondInc}！",
        "no_adventurers_available": "目前公會內沒有正式成員！",
    guild_slots_title: "冒險者宿舍",
guild_effect_slots: "冒險者最大僱用上限",
    reception_effect_quests: "任務看板最大容量",
reception_effect_rolls: "每日任務生成次數",
    reception_level_current: "當前接待處等級",
reception_level_next: "下一等級: {next} (費用: {cost}G)",
reception_desc: "擴建公會大廳，以容納更多任務公告並增加每日任務出現的機會。",
reception_expansion_button: "擴建接待空間",
reception_max_expanded: "接待空間已擴建至最高等級！",
reception_expanded: "接待空間已升級至等級 {level}！公會現在可以處理更多任務了。",
max_expansion_reached: "已達到最大擴建等級。",
    "blacksmith_enhance_failure": "強化失敗！ {item} +{level} 的等級沒有變化，但消耗了強化水晶。",
...
'leave_rejected': '{name} 的 {days} 天休假已被拒絕（好感度 -{penalty}）',
    ...
    "quest_trade_failure_desc3": "預付的購買費用已損失。",
    "quest_trade_success_title": "貿易任務成功！",
    "quest_success_title": "任務成功！",
    "quest_failure_title": "任務失敗！",
    "no_one_returned": "沒有人歸來…",
    "days_taken": "所要日數: {days} 日",
    "multiple_days": "多日",
    "trade_purchased_materials": "購買素材: {materials}",
    "trade_gold_reward": "+{reward} Gold（銷售收益）",
    "reputation_gain": "聲望 +{repGain}",
    "reputation_loss": "聲望 -{repLoss}",
    "gold_reward": "+{gold} Gold",
    "adventurer_payout": " (冒險者分配: {payout}G)",
    "adventurer_payout_note": "[{payout} Gold已分配給冒險者]",
    "exp_short": "經驗值",

    // === 貿易任務盜賊遭遇 ===
    "trade_no_guard_bandit": "無護衛導致大規模盜賊襲擊！\n失去了大部分貨物與收益…（損失率80%）",
    "trade_bandit_attack": "遭遇盜賊襲擊！",
    "trade_bandit_lost_gold": "損失的銷售收益: {lostGold}G",
    "trade_bandit_lost_items": "損失的購買品: {items}",
    "trade_bandit_loss_rate": " 損失率{rate}%",

    // === 通常任務成功獎勵 ===
    "defense_orb_bonus": "聲望獎勵: 獲得 {qty} × 小EXP寶珠！",
    "dungeon_treasure_gold": "地下城第{floor}層寶箱: +{gold}G",
    "enhancement_crystal": "強化水晶",
    "item_found": "發現{name}！",
    "item_found_qty": "發現{name} x{qty}！",
    "rare_indicator": " (稀有！)",
    "cursed_mana_fragment": "被詛咒的魔力碎片",
    "cursed_goblin_guard": "被詛咒的哥布林護衛",
    "carnivorous_flower_tooth": "食肉花的牙齒",
    "collection_item": "(收藏品)",
    "grateful_client_rep": "感激的客戶四處宣傳，+{extraRep} 聲望！",
    "npc_discovered": "發現{npc}！在NPC處確認支線任務。",
    "exp_orb_small": "小EXP寶珠",
    "exp_orb": "EXP寶珠",
    "side_quest_exp_orb": "收到EXP寶珠！（使用可讓冒險者等級+10）",
    "fetch_item_reward": "+{qty} {name}",
