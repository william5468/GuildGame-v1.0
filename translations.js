...
const alchemyRecipes = {
  ...
  en: [
    ...
    {level: 1, inputs: ["Mushroom", "Herb"], output: {name: "Mushroom Healing Potion", type: "potion", restore: "hp", amount: 25, minPrice: 35, maxPrice: 55}},
    {level: 1, inputs: ["Flower", "Common Herb"], output: {name: "Flower Elixir", type: "potion", restore: "mp", amount: 20, minPrice: 25, maxPrice: 45}},
    {level: 1, inputs: ["River Fish", "Mushroom"], output: {name: "Seafood Nourishing Soup", type: "potion", restore: "hp", amount: 35, minPrice: 50, maxPrice: 80}},
    ...
    {level: 2, inputs: ["Wolf Pelt", "Vitality Powder"], output: {name: "Beast Vitality Ointment", type: "potion", restore: "hp", amount: 45, minPrice: 85, maxPrice: 135}},
    ...
    {level: 2, inputs: ["Rare Spice", "Advanced HP Potion"], output: {name: "Spicy Super HP Potion", type: "potion", restore: "hp", amount: 80, minPrice: 250, maxPrice: 390}},
    ...
    {level: 3, inputs: ["Hydra Venom Sac", "Holy Water"], output: {name: "Detoxified Holy Water", type: "potion", restore: "hp", amount: 90, minPrice: 460, maxPrice: 700}},
    ...
    {level: 3, inputs: ["Unicorn Horn", "Holy Water"], output: {name: "Unicorn Purification Potion", type: "potion", restore: "hp", amount: 120, minPrice: 650, maxPrice: 990}},
    ...
    {level: 3, inputs: ["Angel Feather", "Detoxified Holy Water"], output: {name: "Angel Healing Potion", type: "potion", restore: "hp", amount: 140, minPrice: 1020, maxPrice: 1540}},
    ...
    {level: 4, inputs: ["Divine Tear", "Angel Healing Potion"], output: {name: "Divine Tear Divine Potion", type: "potion", restore: "hp", amount: 200, minPrice: 1900, maxPrice: 2860}},
    ...
    {level: 4, inputs: ["World Origin Stone", "Divine Tear Divine Potion"], output: {name: "World Source Divine Potion", type: "potion", restore: "hp", amount: 500, minPrice: 5580, maxPrice: 8380}},
    ...
    {level: 4, inputs: ["World Origin Stone", "Creation Fragment"], output: {name: "Creation Source Potion", type: "potion", restore: "hp", amount: 999, minPrice: 10240, maxPrice: 15360}},
  ...
  zh: [
    ...
    {level: 1, inputs: ["蘑菇", "藥草"], output: {name: "蘑菇回復藥", type: "potion", restore: "hp", amount: 25, minPrice: 35, maxPrice: 55}},
    {level: 1, inputs: ["花朵", "普通藥草"], output: {name: "花之靈藥", type: "potion", restore: "mp", amount: 20, minPrice: 25, maxPrice: 45}},
    {level: 1, inputs: ["河魚", "蘑菇"], output: {name: "海鮮滋養湯", type: "potion", restore: "hp", amount: 35, minPrice: 50, maxPrice: 80}},
    ...
    // === 等級2: 中盤強化 ===
    {level: 2, inputs: ["狼皮", "活力粉末"], output: {name: "獸類活力軟膏", type: "potion", restore: "hp", amount: 45, minPrice: 85, maxPrice: 135}},
    ...
    {level: 2, inputs: ["稀有香料", "上級HP藥劑"], output: {name: "辣味超HP藥", type: "potion", restore: "hp", amount: 80, minPrice: 250, maxPrice: 390}},
    ...
    {level: 3, inputs: ["九頭蛇毒囊", "聖水"], output: {name: "解毒聖水", type: "potion", restore: "hp", amount: 90, minPrice: 460, maxPrice: 700}},
    {level: 3, inputs: ["聖水", "古魔導粉"], output: {name: "聖魔導結晶", type: "material", minPrice: 410, maxPrice: 630}},
    {level: 3, inputs: ["獅鷲羽毛", "森林精華"], output: {name: "天空精華", type: "potion", restore: "mp", amount: 70, minPrice: 245, maxPrice: 375}},

    {level: 3, inputs: ["獨角獸角", "聖水"], output: {name: "獨角獸淨化藥", type: "potion", restore: "hp", amount: 120, minPrice: 650, maxPrice: 990}},
    ...
    {level: 3, inputs: ["天使羽毛", "解毒聖水"], output: {name: "天使癒藥", type: "potion", restore: "hp", amount: 140, minPrice: 1020, maxPrice: 1540}},
    ...
    {level: 4, inputs: ["神之淚", "天使癒藥"], output: {name: "神淚神藥", type: "potion", restore: "hp", amount: 200, minPrice: 1900, maxPrice: 2860}},
    ...
    {level: 4, inputs: ["世界源石", "神淚神藥"], output: {name: "世界源神藥", type: "potion", restore: "hp", amount: 500, minPrice: 5580, maxPrice: 8380}},
    ...
    {level: 4, inputs: ["世界源石", "創世碎片"], output: {name: "創世源藥劑", type: "potion", restore: "hp", amount: 999, minPrice: 10240, maxPrice: 15360}},
