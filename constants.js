...
const TutorialDialogue = [
    {speaker: "ギルドマスター", text: "ようこそ、新米ギルドマスター！\nこのゲームの基本操作と仕組みを簡単に説明するよ。"},
    {speaker: "ギルドマスター", text: "目的はギルドを運営してゴールドと評判を増やし、\n仲間を育てて真実を探ること。\nゴールドか評判がマイナスになるとゲームオーバーになるから注意だ。"},
    {speaker: "ギルドマスター", text: "左側がクエスト一覧だ。\n‹前 / 次›ボタンか、キーボードのA / Dキーでページを切り替えられる。"},
    {speaker: "ギルドマスター", text: "クエストは主に4種類ある。\n・討伐クエスト（STR重視）：モンスター退治。成功すると新しい冒険者が加入するチャンス！\n・探索クエスト（WIS重視）：未知の場所を探る。NPCを発見する可能性あり。\n・護衛クエスト（DEX重視）：対象を安全に送る。評判が少し多めに上がることがある。\n・収集クエスト（LUC重視）：アイテム集め。錬金素材や売却用アイテムが手に入るチャンス。"},
    {speaker: "ギルドマスター", text: "また、常に受けられる「トレーニングクエスト」もある。\n高レベル冒険者が低レベル冒険者に指導を行い、\n低レベル側に経験値を与えられる。\n育成に活用しよう！"},
    {speaker: "ギルドマスター", text: "右上は利用可能な冒険者一覧。\n横にスクロールして確認し、ドラッグ＆ドロップまたはクリックでクエストに配置しよう。"},
    {speaker: "ギルドマスター", text: "右下は募集中の冒険者。\nゴールドを払って雇用できる。\n強い仲間を増やしてクエスト成功率を上げよう。"},
    {speaker: "ギルドマスター", text: "配置が終わったら「日終了 & 冒険者派遣」ボタンを押すか、\nEnterキーを押して1日を進めよう。\n翌日に結果が返ってくる。"},
    {speaker: "ギルドマスター", text: "その他の便利な操作：\n・A / Dキー：クエスト、キャラクター、店のページ切り替え\n・スペースキー：店、キャラクター、イベントログを閉じる"},
    {speaker: "ギルドマスター", text: "施設アップグレードもあるぞ。\n「ギルド周辺」ボタンから鍛冶屋・酒場・錬金工房をゴールドで強化できる。"},
    {speaker: "ギルドマスター", text: "錬金工房ではポーションや素材を作れる。\n鍛冶屋の装備強化や酒場の料理にも必要だ。\n材料は収集クエストや交易クエストで手に入る。"},
    {speaker: "ギルドマスター", text: "「ギルドクエスト投稿」ボタンで自分でクエストを出せる。\nストーリークエスト・ダンジョンクエスト・交易クエストの3種類だ。\n報酬や内容を決めて冒険者を派遣しよう。"},
    {speaker: "ギルドマスター", text: "30日目以降は防衛戦が発生する。\n失敗するとゲームオーバーになるから、\nギルドの戦力をしっかり整えておけ。"},
    {speaker: "ギルドマスター", text: "戦闘はターン制で、DEXが高い冒険者から行動する。\n基本行動は軽攻撃・重攻撃・防御・カウンターだ。"},
    {speaker: "ギルドマスター", text: "軽攻撃：安定したダメージ\n重攻撃：大ダメージだが2APが必要\n防御：被ダメージ軽減\nカウンター：次の敵攻撃を反射\n状況に応じて使い分けよう。"},
    {speaker: "ギルドマスター", text: "これで基本は全部だ。\n分からないことがあればまた「説明」ボタンを押してくれ。\nがんばれ！"}
];
