        ...
        stages: [
            {
                ...
                guidance_beforestage: "プレイヤーが秘密や情報を聞かれたら「200ゴールドで特別な情報を教えてあげるわ」と誘う。game_state_infoにプレイヤーからゴールド200以上の贈り物が含まれていた場合のみ、ルナがいい子なのに最近夜で酒場でよく見かけたらしい、と言う情報を教える。絶対に無料で漏らさない。",
                guidance_afterstage: "ルナがいい子なのに最近夜で酒場でよく見かけたらしい、と言うことを教えたことを覚えている。プレイヤーが戻ってきたら自然に会話を繋げる（例: 「ふふっ、どう？ルナが悪い子かしら？」）。",
            ...
            },
            {
                ...
                guidance_beforestage: "酒場によく見かけるルナの話題を出したら驚いた様子で「えっ！？ どうしてそれを…？ それは…カイトとの秘密なの。あまり聞いてこないで…ね？」と答え、自然に「カイトとの秘密」を落とす。絶対にネタバレしない。",
                guidance_afterstage: "プレイヤーにカイトとの秘密を漏らしたことを覚えている。内容までは教えてなかったはずけど、プレイヤーがさらに聞きたがったら少し焦った様子で誤魔化す。",
            ...
            },
            {
                ...
                guidance_beforestage: "プレイヤーがカイトとルナの秘密を話したらニヤリと笑って「おっ、バレちまったか。今夜酒場に戻ってみなよ、その時本当のこと教えるね！」と言う。",
                guidance_afterstage: "プレイヤーに夜の酒場に戻るようヒントを出したことを覚えている。プレイヤーが戻ってきたら「どうだ？面白いことになってるだろ？」とからかう。",
            ...
            },
            {
                ...
                guidance_beforestage: "プレイヤーがカイトのヒントで戻ってきたら「ふふっ、ちょうどいいタイミングね、いいワインがくれたら本当にこと教えるね♪」とワインの必要性を自然に匂わせる。",
