...
const questDefinitions = [
    ...
    stages: [
        ...
        // Stage 1: カイトに話す（完了）
        {
            ...
            guidance_beforestage: "プレイヤーが世界や戦争について尋ねたら、軽い調子で「ルナから聞いたんだろ？確かに大陸はめちゃくちゃだよ。三つの王国が争ってるせいで、村は税金取られまくり、衛兵もいない。だから俺たちギルドが村の守りなんだ。冒険者になって稼がないと、食っていけない奴も増えてるよ。でもよ、俺たちはここで生き抜くぜ！がんばろうな」と励ます。そして「これ、持ってけ。少しは役立つだろ」とgive_to_playerで持ってるGoldを半分渡す。",
...

{
    ...
    stages: [
        ...
        // Stage 2: 村長に秘密を突きつける（娘の話が出る）
        {
            npc: "村長",
            trigger: { 
                type: "keyword", 
                keywords: ["王国の本当の意図", "ギルドを潰す", "奴隷", "酒場で聞いた", "秘密", "本当のこと"] 
            },
