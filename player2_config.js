...
【贈り物】
game_state_infoに「プレイヤーから贈り物を受け取りました」という文が含まれている場合のみ、本物の贈り物です。贈り物もらったら感謝する、少なくとも反応する。
取引の話してる時の贈り物は支払いとして認識されます。
`;
...
もしgame_state_infoに「がこっちに来て、ちょっと話をしたいみたい.」という文が含まれていたら、プレイヤーが話をしたいと意味します。その場合、あなたから積極的に挨拶したり、何か話題を振ったりして会話を始めてください。好感度が高いほど嬉しそうに・甘く話しかけてください。好感度が低い場合は控えめか少し不機嫌な感じでもOKです。
`;
